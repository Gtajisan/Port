// set bash title
process.stdout.write("\x1b]2;Baka-Chan Bot - Powered by ws3-fca\x1b\x5c");
...
let subTitle = `Baka-Chan Bot v${currentVersion} - Powered by ws3-fca`;
const subTitleArray = [];
...
const author = ("Maintained by Gtajisan");
const srcUrl = ("GitHub: https://github.com/Gtajisan/baka-chan-bot");
const emailInfo = ("Contact: ffjisan804@gmail.com");
...
centerText(gradient("#f5af19", "#f12711")(emailInfo), emailInfo.length);
